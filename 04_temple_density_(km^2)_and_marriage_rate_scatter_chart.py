# -*- coding: utf-8 -*-
"""04_Temple Density (km^2) and Marriage Rate scatter chart
...
r_value, p_value = pearsonr(df['Temple Density (km^2)'], df['Marriage Rate'])
...
plt.title(f'Temple Density and Marriage Rate\nr = {r_value:.2f}, p = {p_value:.3f}')
