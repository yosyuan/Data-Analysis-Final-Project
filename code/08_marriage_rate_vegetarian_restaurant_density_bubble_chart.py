# -*- coding: utf-8 -*-
"""08_Marriage Rate_Vegetarian Restaurant Density_Bubble_chart
...
r, p = pearsonr(df['Marriage Rate'], df['Vegetarian Restaurant Density (km^2)'])
...
plt.title('Marriage Rate vs. Vegetarian Restaurant Density\n(Bubble Size = Temple Density (km^2))')
