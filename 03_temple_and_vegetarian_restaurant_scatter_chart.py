# -*- coding: utf-8 -*-
"""03_Temple and Vegetarian Restaurant scatter chart
...
sns.lmplot(
    x='Temple Density (km^2)',                      # X-axis: total number of people kissed
    y='Vegetarian Restaurant Density (km^2)',               # Y-axis: age when the participant had their first kiss
    data=df,
...
plt.title(f'Temple and Vegetarian Restaurant\nr = {r_value:.2f}, p = {p_value:.3f}')

# Label the axes
plt.xlabel('Temple Density ')
plt.ylabel('Vegetarian Restaurant Density ')
